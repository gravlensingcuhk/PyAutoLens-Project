"""
Prepare the no-subhalo baseline (run ONCE, before the 16 tile jobs)
===================================================================
...
saves ~16 baseline fits' worth of compute and gives every tile the *same* reference evidence,
...
# 16 tile jobs load the exact same result.
#
